package pe.edu.vallegrande.vaccine.rest;
...
import pe.edu.vallegrande.vaccine.services.VaccineServices;
...
public class VaccineController {
    ...
    public Mono<ResponseEntity<VaccineModel>> createVaccine(@RequestBody VaccineModel vaccine) {
        ...
        vaccine.setId(null); // O asegurarte de que el id sea null antes de guardar
